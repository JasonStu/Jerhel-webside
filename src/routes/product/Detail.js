	...
	return (
		<div className={styles.content}>
			...
			<div className={styles.relate}>
				<div className={styles.subtitle}>RELATED PRODUCTS</div>
				<div className={styles.list}>
					<div className={styles.item}>
						<img
							alt=""
							src={'/image/product_detail/relate_1.png'}
						/>
						<div className={styles.text}>PAN SIZE FILTER</div>
					</div>
					<div className={styles.item}>
						<img
							alt=""
							src={'/image/product_detail/relate_2.png'}
						/>
						<div className={styles.text}>PAN SIZE FILTER</div>
					</div>
					<div className={styles.item}>
						<img
							alt=""
							src={'/image/product_detail/relate_3.png'}
						/>
						<div className={styles.text}>PAN SIZE FILTER</div>
					</div>
				</div>
